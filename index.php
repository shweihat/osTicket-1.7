...
<div id="landing_page">
    ...
    <div id="new_ticket">
        ...
        <p>
            <a href="open.php" class="green button">Open a New Incident</a>
        </p>
    </div>

    <div id="check_status">
        <h3>Check Incident Status</h3>
        <br>
        <div>We provide archives and history of all your current and past support requests complete with responses.</div>
        <p>
            <a href="view.php" class="blue button">Check Incident Status</a>
        </p>
    </div>
</div>
<div class="clear"></div>
...
?>
<p>Be sure to browse our <a href="kb/index.php">Frequently Asked Questions (FAQs)</a>, before opening an incident.</p>
</div>
<?php
} ?>
